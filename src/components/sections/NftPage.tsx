  ...
  return (
    ...
    <div className="flex flex-col justify-center item-center  w-3/4 bg-gray-800 mx-auto">
      <div className="container my-10 mx-auto h-full text-center align-middle">
        {/* Fetch NFT Name */}
        <h1 className="text-3xl font-bold mb-5 text-white text-center">NFT Name</h1>
        <p className="text-1xl font-bold mb-5 text-white justify-center text-center">NFT Description</p>
        <p className="text-1xl font-bold mb-5 text-white justify-center text-center">Price</p>
