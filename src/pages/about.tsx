...
export default function About(){
    ...
    return(
        <div className='bg-gray-800'>
            ...
            <TextField header={"Hakkımızda"} content={"Parla-TR NFT bir blokzincir projesidir. Bu projenin amacı Türkiye Cumhuriyeti'nin 100 yıllık kazanımlarını, blokzincirinde sunarak hem kalıcılaştırmak hem de bu sayede bireylerin blok zincirine olan aşinalığını artırmak hedeflenmektedir."}/>
            <Footer />
        </div>
    )
}
